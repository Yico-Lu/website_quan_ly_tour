        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-8 mb-3">
                    ...
                    <input
                        ...
                        id="ten_danh_muc"
                        name="ten_danh_muc"
                        value="<?= htmlspecialchars($old['ten_danh_muc'] ?? $category->ten_danh_muc) ?>"
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="form-check">
                        <input
                            ...
                            name="trang_thai"
                            value="1"
                            <?= ($old['trang_thai'] ?? $category->trang_thai) ? 'checked' : '' ?>
                        />
            ...
            <div class="mb-3">
                ...
                <textarea
                    ...
                    required
                ><?= htmlspecialchars($old['mo_ta'] ?? $category->mo_ta) ?></textarea>
            </div>
        </div>
